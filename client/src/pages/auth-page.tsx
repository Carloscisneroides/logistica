          ...
          <div className="text-center space-y-6 max-w-4xl mx-auto">
            ...
            <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-6 border border-white/20 shadow-2xl text-center">
              <p className="text-white text-lg font-semibold leading-relaxed">
                <span className="text-cyan-300 font-black">{BRAND_NAME}</span> connette <span className="text-cyan-300">logistica globale</span>, <span className="text-cyan-300">eCommerce</span> e <span className="text-cyan-300">marketplace</span> in un'unica rete intelligente. Protezione antifrode <span className="text-cyan-300">AI-powered 24/7</span> e strumenti di <span className="text-cyan-300">marketing operativo</span> integrati.
              </p>
            </div>
          </div>
        </div>
